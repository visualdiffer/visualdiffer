//
//  FilePreferencesComparisonPanel.swift
//  VisualDiffer
//
...
class FilePreferencesComparisonPanel: NSView, PreferencesPanelDataSource {
    ...
    override init(frame frameRect: NSRect) {
        stackView = NSStackView.preferences(with: [
            FileComparisonBox(title: NSLocalizedString("Comparison", comment: "")),
        ])
