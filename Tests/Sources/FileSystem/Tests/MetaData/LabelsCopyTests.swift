...
final class LabelsCopyTests: BaseTests {
    @Test
    func copyFolderWithLabels() throws {
        ...
        do {
            ...
            assertItem(child3, 0, 0, 0, 2, 1, "Level2", .mismatchingLabels, 16)
            ...
            assertItem(child3.linkedItem, 0, 0, 0, 2, 1, "Level2", .mismatchingLabels, 16)
