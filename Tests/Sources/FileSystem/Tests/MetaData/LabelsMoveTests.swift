...
final class LabelsMoveTests: BaseTests {
    @Test
    func moveFolderWithLabels() throws {
        ...
        do {
            ...
            assertItem(child1, 0, 0, 0, 4, 2, "l", .orphan, 26)
            ...
            assertItem(child1.linkedItem, 0, 0, 0, 4, 2, "r", .orphan, 26)
            ...
            assertItem(child2, 0, 0, 0, 3, 2, "Parent", .orphan, 21)
            ...
            assertItem(child2.linkedItem, 0, 0, 0, 3, 2, "Parent", .orphan, 21)
            ...
            assertItem(child4, 0, 0, 0, 2, 2, "FolderWithLabels", .mismatchingLabels, 16)
            ...
            assertItem(child4.linkedItem, 0, 0, 0, 2, 2, "FolderWithLabels", .mismatchingLabels, 16)
            ...
            assertItem(child7, 0, 0, 0, 1, 0, "line2.txt", .same, 5)
            ...
            assertItem(child7.linkedItem, 0, 0, 0, 1, 0, "line2.txt", .same, 5)
        ...
        do {
            let child1 = rootL // l <-> r
            assertItem(child1, 0, 0, 0, 2, 2, "l", .orphan, 10)
            #expect(child1.orphanFolders == 0, "OrphanFolder: Expected count \(0) found \(child1.orphanFolders)")
            assertFolderLabels(child1, false, "l")
            assertMismatchingLabels(child1, 1, "l")
            assertResourceFileLabels(child1, 0, appendFolder("l"))
            assertItem(child1.linkedItem, 0, 0, 2, 2, 2, "r", .orphan, 26)
            ...
            let child2 = child1.children[0] // l <-> r
            assertItem(child2, 0, 0, 0, 1, 2, "Parent", .orphan, 5)
            #expect(child2.orphanFolders == 0, "OrphanFolder: Expected count \(0) found \(child2.orphanFolders)")
            assertFolderLabels(child2, false, "Parent")
            assertMismatchingLabels(child2, 1, "Parent")
            assertResourceFileLabels(child2, 0, appendFolder("l/Parent"))
            assertItem(child2.linkedItem, 0, 0, 2, 1, 2, "Parent", .orphan, 21)
