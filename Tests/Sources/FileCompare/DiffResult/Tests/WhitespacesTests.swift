...
final class WhitespacesTests: DiffResultBaseTests {
    @Test func ignoreLeadingWhitespacesTests() {
        let leftText =
            "    leading spaces\n" +
            "  another line"
        let rightText =
    ...
    @Test func ignoreInternalWhitespacesTests() {
        let leftText =
            "   line1\n" +
    ...
    @Test func ignoreAllWhitespacesTests() {
        let leftText =
            "   line1\n" +
            "another    text\t\ttabs and  spaces\r\n" +
            "last line     "
    ...
    @Test("Ignore all whitespaces differences but compare EOLs") func ignoreAllWhitespacesThenEolTests() {
        let leftText =
            "   line1\n" +
            "another    text\t\ttabs and  spaces\r\n" +
            "last line     "
